...
import org.klv.john.objects.Monstre.MobGrade;
...
public class Carte {
	...
	public static class MountPark
	{
		...
		{
			for(Entry<Short, org.klv.john.objects.Carte.MountPark> mp : World.data.getMountPark().entrySet())//Pour chaque enclo si ils en ont plusieurs
			{
