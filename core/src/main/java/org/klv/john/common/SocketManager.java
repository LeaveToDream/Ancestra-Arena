...
import org.klv.john.objects.Carte.InteractiveObject;
...
import org.klv.john.objects.Monstre.MobGroup;
...
public class SocketManager {
	...
	{
		String packet = "EL";
		HdvEntry[] entries = perso.get_compte().getHdvItems(Math.abs(perso.get_isTradingWith()));	//Récupére un tableau de tout les items que le personnage é en vente dans l'HDV oé il est
