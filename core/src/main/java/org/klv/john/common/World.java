...
import org.klv.john.game.GameClient;
...
import org.klv.john.objects.Animations;
import org.klv.john.objects.Area;
...
import org.klv.john.objects.ExpLevel;
...
import org.klv.john.objects.IOTemplate;
import org.klv.john.objects.ItemSet;
import org.klv.john.objects.Monstre;
...
import org.klv.john.objects.job.Job;
import org.klv.john.objects.Percepteur;
import org.klv.john.objects.Personnage;
import org.klv.john.objects.PierreAme;
import org.klv.john.objects.Sort;
import org.klv.john.objects.SubArea;
import org.klv.john.objects.SuperArea;
import org.klv.john.objects.Trunk;
import org.klv.john.tool.command.Command;
import org.klv.john.core.Console;
import org.klv.john.core.Log;
import org.klv.john.core.Main;
import org.klv.john.core.Server;
import org.klv.john.database.Database;
...
public class World {
	...
	public int initialize() {
		...
		//truc pourri é refaire plus tard
	...
	public void Wedding(Personnage Homme, Personnage Femme, int isOK) {
		if (isOK > 0) {
			SocketManager.GAME_SEND_cMK_PACKET_TO_MAP(Homme.get_curCarte(), "",
					-1, "Prétre", "Je déclare " + Homme.get_name() + " et "
							+ Femme.get_name()
