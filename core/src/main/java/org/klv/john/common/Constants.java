...
import org.klv.john.objects.Personnage.Stats;
import org.klv.john.objects.Sort.SortStats;
import org.klv.john.objects.job.Job.JobAction;
...
public class Constants
{
	...
	public static void onLevelUpSpells(Personnage perso,int lvl)
	{
		switch(perso.get_classe())
		{
			case CLASS_FECA:
				...
				if(lvl == 36)
					perso.learnSpell(5, 1,true,false);//Tréve
				if(lvl == 42)
					perso.learnSpell(16, 1,true,false);//Science du béton
				if(lvl == 48)
					perso.learnSpell(8, 1,true,false);//Retour du béton
				if(lvl == 54)
			...
			case CLASS_OSAMODAS:
				...
				if(lvl == 26)
					perso.learnSpell(27, 1,true,false);//Piqére Motivante
				if(lvl == 31)
			...
			case CLASS_ENUTROF:
				...
				if(lvl == 9)
					perso.learnSpell(47, 1,true,false);//Boéte de Pandore
				if(lvl == 13)
			...
			case CLASS_SRAM:
				...
				if(lvl == 21)
					perso.learnSpell(79, 1,true,false);//Piége de Masse
				if(lvl == 26)
					perso.learnSpell(78, 1,true,false);//Invisibilité d'Autrui
				if(lvl == 31)
					perso.learnSpell(71, 1,true,false);//Piége Empoisonné
				if(lvl == 36)
					perso.learnSpell(62, 1,true,false);//Concentration de Chakra
				if(lvl == 42)
					perso.learnSpell(69, 1,true,false);//Piége d'Immobilisation
				if(lvl == 48)
					perso.learnSpell(77, 1,true,false);//Piége de Silence
				if(lvl == 54)
					perso.learnSpell(73, 1,true,false);//Piége répulsif
				if(lvl == 60)
				...
				if(lvl == 100)
					perso.learnSpell(80, 1,true,false);//Piége Mortel
				if(lvl == 200)
			...
			case CLASS_XELOR:
				...
				if(lvl == 26)
					perso.learnSpell(96, 1,true,false);//Poussiére Temporelle
				if(lvl == 31)
			...
			case CLASS_ECAFLIP:
				...
				if(lvl == 13)
					perso.learnSpell(104, 1,true,false);//Tréfle
				if(lvl == 17)
				...
				if(lvl == 31)
					perso.learnSpell(116, 1,true,false);//Langue Répeuse
				if(lvl == 36)
			...
			case CLASS_IOP:
				...
				if(lvl == 60)
					perso.learnSpell(156, 1,true,false);//Tempéte de Puissance
				if(lvl == 70)
				...
				if(lvl == 100)
					perso.learnSpell(159, 1,true,false);//Colére de Iop
				if(lvl == 200)
			...
			case CLASS_CRA:
				if(lvl == 3)
					perso.learnSpell(163, 1,true,false);//Fléche Glacée
				if(lvl == 6)
					perso.learnSpell(165, 1,true,false);//Fléche enflammée
				if(lvl == 9)
					perso.learnSpell(172, 1,true,false);//Tir Eloigné
				if(lvl == 13)
					perso.learnSpell(167, 1,true,false);//Fléche d'Expiation
				if(lvl == 17)
					perso.learnSpell(168, 1,true,false);//Oeil de Taupe
				if(lvl == 21)
					perso.learnSpell(162, 1,true,false);//Tir Critique
				if(lvl == 26)
					perso.learnSpell(170, 1,true,false);//Fléche d'Immobilisation
				if(lvl == 31)
					perso.learnSpell(171, 1,true,false);//Fléche Punitive
				if(lvl == 36)
					perso.learnSpell(166, 1,true,false);//Tir Puissant
				if(lvl == 42)
					perso.learnSpell(173, 1,true,false);//Fléche Harcelante
				if(lvl == 48)
					perso.learnSpell(174, 1,true,false);//Fléche Cinglante
				if(lvl == 54)
					perso.learnSpell(176, 1,true,false);//Fléche Persécutrice
				if(lvl == 60)
					perso.learnSpell(175, 1,true,false);//Fléche Destructrice
				if(lvl == 70)
					perso.learnSpell(178, 1,true,false);//Fléche Absorbante
				if(lvl == 80)
					perso.learnSpell(177, 1,true,false);//Fléche Ralentissante
				if(lvl == 90)
					perso.learnSpell(179, 1,true,false);//Fléche Explosive
				if(lvl == 100)
					perso.learnSpell(180, 1,true,false);//Maétrise de l'Arc
				if(lvl == 200)
			...
			case CLASS_SACRIEUR:
				...
				if(lvl == 13)
					perso.learnSpell(437, 1,true,false);//Chétiment Agile
				if(lvl == 17)
					perso.learnSpell(439, 1,true,false);//Dissolution
				if(lvl == 21)
					perso.learnSpell(433, 1,true,false);//Chétiment Osé
				if(lvl == 26)
					perso.learnSpell(443, 1,true,false);//Chétiment Spirituel
				if(lvl == 31)
					perso.learnSpell(440, 1,true,false);//Sacrifice
				if(lvl == 36)
					perso.learnSpell(442, 1,true,false);//Absorption
				if(lvl == 42)
					perso.learnSpell(441, 1,true,false);//Chétiment Vilatesque
				if(lvl == 48)
			...
			case CLASS_PANDAWA:
				...
				if(lvl == 54)
					perso.learnSpell(700, 1,true,false);//Vague é Lame
				if(lvl == 60)
					perso.learnSpell(701, 1,true,false);//Colére de Zatoéshwan
				if(lvl == 70)
	...
	{
		//Gére les differentes actions des "bornes" (IO des émotes)
		switch(mID)
		{
